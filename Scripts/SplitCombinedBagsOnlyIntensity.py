...
def main():
    fileLists = {
        'Bags' : 'FileLists/CombinedBagsOnlyIntensity.csv',
    }

    outdirs = {
        'ERU' : 'PatchSize21mm/OnlyIntensity/RightUpper',
        'ERM' : 'PatchSize21mm/OnlyIntensity/RightMiddle',
        'ERL' : 'PatchSize21mm/OnlyIntensity/RightLower',
        'ELU' : 'PatchSize21mm/OnlyIntensity/LeftUpper',
        'ELM' : 'PatchSize21mm/OnlyIntensity/LeftMiddle',
        'ELL' : 'PatchSize21mm/OnlyIntensity/LeftLower',
    }
