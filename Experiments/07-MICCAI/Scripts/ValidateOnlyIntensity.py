...
def main(argv=None):
    ...
    modelPattern = 'Out/Training/PatchSize21mm/OnlyIntensity/%s_%s_%s_k%s_1.model'
    ...
    for region in regions:
        for k in numberOfClusters:
            out = 'Out/Validation/PatchSize21mm/OnlyIntensity/%s_%s_%s_k%s' % (experiment + (region, k,))
            cmd = [
                progs['Intervals'],
