...
#include "NearestNeighbourTrainer.h"
...
int main(int argc, char *argv[]) {
  ...
  typedef NearestNeighbourTrainer< DistanceFunctorType,
				   BagProportionError > TrainerType;
  ...
  NearestNeighbourTrainerParameters trainerParams(
  ...
  TrainerType trainer( trainerParams );
