#ifndef __NearestNeighbourTrainerParameters_h
#define __NearestNeighbourTrainerParameters_h

struct NearestNeighbourTrainerParameters {
  /*
  ...
  */
  NearestNeighbourTrainerParameters( std::size_t featureSpaceDimension,
				     std::size_t k,
				     int maxIterations = 0,
				     std::string out = "",
				     double sigma = -1,
