#ifndef __ClusterModelTrainerNoCMAES_h
#define __ClusterModelTrainerNoCMAES_h
...
template< typename TClusterer,
	  typename TLabeller >
class ClusterModelTrainerNoCMAES
{
public:
  typedef ClusterModelTrainerNoCMAES< TClusterer, TLabeller > Self;
  ...
  */
   ...
   */
  ClusterModelTrainerNoCMAES( ClustererType& clusterer,
...
#include "ClusterModelTrainerNoCMAES.hxx"
